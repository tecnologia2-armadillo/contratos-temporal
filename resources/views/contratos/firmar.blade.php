    ...
    <div class="wrapper">
        ...
        <div class="card">
            ...
            <form action="{{ route('firmar.validar', $contrato->id) }}" method="POST"
                onsubmit="this.querySelector('button[type=submit]').disabled=true; this.querySelector('button[type=submit]').innerText='Procesando...';">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select id="tipo_identificacion" name="tipo_identificacion" required>
                        ...
                        <option value="CC" {{ old('tipo_identificacion') === 'CC' ? 'selected' : '' }}>Cédula de
                            Ciudadanía (CC)</option>
                        <option value="CE" {{ old('tipo_identificacion') === 'CE' ? 'selected' : '' }}>Cédula de
                            Extranjería (CE)</option>
                        <option value="PA" {{ old('tipo_identificacion') === 'PA' ? 'selected' : '' }}>Pasaporte (PA)
                        </option>
                        <option value="TI" {{ old('tipo_identificacion') === 'TI' ? 'selected' : '' }}>Tarjeta de
                            Identidad (TI)</option>
                        <option value="NIT" {{ old('tipo_identificacion') === 'NIT' ? 'selected' : '' }}>NIT</option>
                        <option value="PPT" {{ old('tipo_identificacion') === 'PPT' ? 'selected' : '' }}>Permiso por
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="numero_identificacion" name="numero_identificacion"
                        value="{{ old('numero_identificacion') }}" placeholder="Ej: 1234567890" inputmode="numeric"
