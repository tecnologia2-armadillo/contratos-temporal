    ...
    <div class="container">
        <div class="card">
            ...
            <div class="info-alert">
                No encontramos tus datos en nuestro sistema. Por favor regístrate para proceder con la firma del
            ...
            <form id="registro-firma-form" action="{{ route('firmar.registro_nv.post', $contrato->id) }}" method="POST">
                ...
                <div class="contract-section">
                    ...
                    <div class="signature-area">
                        <div
                            style="display:flex;justify-content:space-between;align-items:center;margin-bottom:.75rem;">
                        ...
                        <div id="upload-container" style="display:none;">
                            <div class="upload-zone">
                                ...
                                <button type="button" class="btn btn-outline"
                                    onclick="document.getElementById('signature-photo').click()">📷 Seleccionar imagen
                                    de firma</button>
                    ...
                    <button type="submit" class="btn btn-primary" id="save" disabled>Lee el contrato hasta el final para
                        habilitar</button>
                </div>
            </form>
        </div>
