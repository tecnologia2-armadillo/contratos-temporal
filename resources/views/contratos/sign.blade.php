...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .btn-outline:hover { color:var(--text-main); border-color:rgba(255,255,255,.3); }
        ...
        .error-alert { background:rgba(239,68,68,.1); color:#f87171; border:1px solid rgba(239,68,68,.2); padding:.85rem 1rem; border-radius:.75rem; margin-bottom:1.25rem; font-size:.875rem; display:flex; align-items:center; gap:.6rem; }
...
<body>
    <div class="container">
        <div class="card">
            ...
            <form id="signature-form" action="{{ route('firmar.sign.post', [$contrato->id, $token]) }}" method="POST">
                @csrf
    ...
    <script>
        ...
        document.getElementById('signature-form').addEventListener('submit', function(e) {
            if (mode === 'canvas') {
                if (signaturePad.isEmpty()) { alert('Por favor, ingresa tu firma antes de continuar.'); e.preventDefault(); return; }
        ...
        function checkScroll() {
            ...
            if (contractBox.scrollHeight - contractBox.scrollTop <= contractBox.clientHeight + 20) {
                ...
                saveBtn.innerText = 'Firmar y Descargar PDF';
            }
        }
