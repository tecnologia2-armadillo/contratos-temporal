...
<body>
    ...
    <div class="info-grid">
        ...
        <div class="info-item"><span class="info-label">Identificación:</span> {{ $person['tipo_identificacion'] }} {{ $person['identificacion'] }}</div>
    ...
    <div class="signature-section">
        ...
        {{ $person['tipo_identificacion'] }} {{ $person['identificacion'] }}</p>
    </div>
